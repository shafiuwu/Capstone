...
const LoginOrg = () => {
  ...
  const handleLogin = async () => {
    try {
      const response = await axios.post('http://localhost:4000/organizaciones/login', {
        correo: email, 
        contrasena: password, 
              ...
              <div className="card" style={{ borderRadius: '1rem'}}>
                <div className="row g-0">
                  <div className="col-md-6 col-lg-5 d-none d-md-block">
                    <img src="/images/header.png" alt="login form" className="img-fluid"
                      style={{
                    ...
                    <div className="card-body p-4 p-lg-5 text-black">
                      <form onSubmit={(e) => { e.preventDefault(); handleLogin(); }}>
                        <div className="d-flex align-items-center mb-3 pb-1">
                          ...
                          <span className="fs-5 fw-light mb-0 font-italic" style={{marginTop: "18px", marginLeft: "5px"}}>colaboradores</span>
                        </div>
